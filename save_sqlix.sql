...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sqlix` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `habitant` (
  ...
  CONSTRAINT `habitant_ibfk_1` FOREIGN KEY (`num_village`) REFERENCES `village` (`num_village`),
  CONSTRAINT `habitant_ibfk_2` FOREIGN KEY (`num_qualite`) REFERENCES `qualite` (`num_qualite`)
...
CREATE TABLE `resserre` (
  ...
  CONSTRAINT `resserre_ibfk_2` FOREIGN KEY (`num_village`) REFERENCES `village` (`num_village`)
...
CREATE TABLE `village` (
  ...
  CONSTRAINT `village_ibfk_2` FOREIGN KEY (`num_province`) REFERENCES `province` (`num_province`)
...
-- Dump completed on 2021-02-22 13:29:46
